...
class SyncOperator extends AsyncTask<Void, Void, String>
{
	...
	protected void onPreExecute() {
		...
		progressDialogShowHelper.show(activity, R.string.loading_sync);
	}
	...
	private String loadSyncSpreadsheetKeyFromPreferences() {
		return PreferencesOperator.get(activity, PreferencesOperator.PREFERENCE_SYNC_SPREADSHEET_KEY);
	}

	private void saveSyncSpreadsheetKeyToPreferences(String syncSpreadsheetKey) {
		PreferencesOperator.set(activity, PreferencesOperator.PREFERENCE_SYNC_SPREADSHEET_KEY,
			syncSpreadsheetKey);
	}
